...
sudo scutil --set ComputerName "Kal-El"
sudo scutil --set HostName "Kal-El"
sudo scutil --set LocalHostName "Kal-El"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Kal-El"
